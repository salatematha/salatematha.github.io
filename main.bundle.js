...
var PortfolioComponent = (function () {
    function PortfolioComponent(router, quoteService, favStockService, authService, route, dialog) {
        ...
        this.displayedColumns = ['stock', 'quantity', 'price', 'lastPrice', 'dayChangePercentage', 'current', 'profit', 'profit_percentage'];
        this.exampleDatabase = new ExampleDatabase();
    }
    PortfolioComponent.prototype.CanEdit = function (val) {
        this.canEdit = val;
        if (val) {
            this.displayedColumns.push('key');
            this.displayedColumns.push('key1');
        }
        else {
...
var SymbolService = (function () {
    function SymbolService(http) {
        ...
        this.stocks = ['SPY', 'VTI', 'VOO', 'QQQ', 'MMM', 'AIEQ', 'GBTC', 'DIA',
            'ABT',
            'ABBV',
            'ACN',
            'ATVI',
